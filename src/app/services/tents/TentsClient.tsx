...
export default function TentsClient() {
    ...
    const servicesList = [
        t('tentsService1' as any),
        t('tentsService2' as any),
        t('tentsService3' as any),
        t('tentsService4' as any),
        t('tentsService5' as any),
    ];

    const features = [
        { title: t('tFeature1Title' as any), desc: t('tFeature1Desc' as any) },
        { title: t('tFeature2Title' as any), desc: t('tFeature2Desc' as any) },
        { title: t('tFeature3Title' as any), desc: t('tFeature3Desc' as any) },
        { title: t('tFeature4Title' as any), desc: t('tFeature4Desc' as any) },
    ];
        ...
        <main className="min-h-screen bg-slate-50 relative">
            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/khym/خيم ملكي وبيوت شعر ديار جدة  (6).jpg"
                        alt={t('tentsPageTitle' as any)}
                        fill
                ...
                <div className="relative z-10 text-center text-white px-4">
                    <h1 className="text-4xl md:text-6xl font-bold mb-4">{t('tentsPageTitle' as any)}</h1>
                    <p className="text-xl md:text-2xl text-slate-200 max-w-2xl mx-auto">
                        {t('tentsHeroSubtitle' as any)}
                    </p>
                </div>
            </section>
            ...
            <div className="container mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <aside className="lg:col-span-1 space-y-8 h-fit lg:sticky lg:top-24">
                    <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-100">
                        <h3 className="text-xl font-bold text-brand-primary mb-4 border-b pb-2">{t('tentsServicesListTitle' as any)}</h3>
                ...
                <article className="lg:col-span-2 prose prose-lg prose-slate max-w-none">
                    <h2 className="text-3xl font-bold text-brand-primary mb-6">{t('tentsWhyTitle' as any)}</h2>
                    <p className="text-slate-600 leading-relaxed mb-8">
                        {t('tentsWhyDesc' as any)}
                    </p>
                    ...
                    <h2 className="text-3xl font-bold text-brand-primary mb-6">معرض صور بيوت الشعر والخيام</h2>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                        {[
                            ...
                            <div key={idx} className="relative h-48 md:h-64 rounded-xl overflow-hidden group shadow-md border border-slate-100">
                                <Image
                                    src={src}
                                    alt={`بيوت شعر وخيام جدة - تصميم ${idx + 1}`}
                                    fill
                    ...
                    <h2 className="text-2xl font-bold text-brand-primary mb-6">{t('tTypesTitle' as any)}</h2>

                    <div className="grid grid-cols-1 gap-8">
                        {/* Royal Tents */}
                        <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100">
                            <div className="relative h-64 w-full group overflow-hidden">
                                <Image src="/images/khym/خيم ملكي وبيوت شعر ديار جدة  (10).jpg" alt={t('tType1Title' as any)} fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                            </div>
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2">{t('tType1Title' as any)}</h3>
                                <p className="text-slate-600">{t('tType1Desc' as any)}</p>
                            </div>
                        </div>

                        {/* Ready-Made Hair Houses */}
                        <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100">
                            <div className="relative h-64 w-full group overflow-hidden">
                                <Image src="/images/khym/خيم ملكي وبيوت شعر ديار جدة  (7).jpg" alt={t('tType2Title' as any)} fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                            </div>
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2">{t('tType2Title' as any)}</h3>
                                <p className="text-slate-600">{t('tType2Desc' as any)}</p>
                            </div>
                        </div>

                        {/* Glass Tents - Using image 11 as a placeholder or example of luxury */}
                        <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100">
                            <div className="relative h-64 w-full group overflow-hidden">
                                <Image src="/images/khym/خيم ملكي وبيوت شعر ديار جدة  (11).jpg" alt={t('tType3Title' as any)} fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                            </div>
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2">{t('tType3Title' as any)}</h3>
                                <p className="text-slate-600">{t('tType3Desc' as any)}</p>
                            </div>
                        </div>
                    </div>
