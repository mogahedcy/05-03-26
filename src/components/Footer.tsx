...
export default function Footer() {
    ...
    const socialLinks = [
        ...
        { icon: BsInstagram, href: 'https://www.instagram.com/aldiyarglobal', label: 'Instagram', color: 'hover:text-pink-500' },
        { icon: FaTiktok, href: 'https://vm.tiktok.com/ZShKSH6o9/', label: 'TikTok', color: 'hover:text-black' }
    ];
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-start gap-4">
                                ...
                                <div>
                                    <span className="block text-white font-medium mb-1">ksaaldeyar@gmail.com</span>
                                    <span className="text-xs text-slate-500">{t('email' as any) || 'البريد الإلكتروني'}</span>
                                </div>
                            </li>
                        </ul>
                    </div>
