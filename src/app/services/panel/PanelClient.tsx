...
export default function PanelClient() {
    ...
    const servicesList = [
        t('panelService1' as any),
        t('panelService2' as any),
        t('panelService3' as any),
        t('panelService4' as any),
    ];

    const features = [
        { title: t('pnFeature1Title' as any), desc: t('pnFeature1Desc' as any) },
        { title: t('pnFeature2Title' as any), desc: t('pnFeature2Desc' as any) },
        { title: t('pnFeature3Title' as any), desc: t('pnFeature3Desc' as any) },
        { title: t('pnFeature4Title' as any), desc: t('pnFeature4Desc' as any) },
    ];
        ...
        <main className="min-h-screen bg-slate-50 relative">
            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/sandwich-panel/sandwich-panel-1.jpg"
                        alt={t('panelPageTitle' as any)}
                        fill
                ...
                <div className="relative z-10 text-center text-white px-4">
                    <h1 className="text-4xl md:text-6xl font-bold mb-4">{t('panelPageTitle' as any)}</h1>
                    <p className="text-xl md:text-2xl text-slate-200 max-w-2xl mx-auto">
                        {t('panelHeroSubtitle' as any)}
                    </p>
                </div>
            </section>
            ...
            <div className="container mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <aside className="lg:col-span-1 space-y-8 h-fit lg:sticky lg:top-24">
                    <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-100">
                        <h3 className="text-xl font-bold text-brand-primary mb-4 border-b pb-2">{t('panelServicesListTitle' as any)}</h3>
                ...
                <article className="lg:col-span-2 prose prose-lg prose-slate max-w-none">
                    <h2 className="text-3xl font-bold text-brand-primary mb-6">{t('panelWhyTitle' as any)}</h2>
                    <p className="text-slate-600 leading-relaxed mb-8">
                        {t('panelWhyDesc' as any)}
                    </p>
                    ...
                    <h2 className="text-3xl font-bold text-brand-primary mb-6">معرض صور ساندوتش بانل وهناجر</h2>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                        {[
                            ...
                            <div key={idx} className="relative h-48 md:h-64 rounded-xl overflow-hidden group shadow-md border border-slate-100">
                                <Image
                                    src={src}
                                    alt={`هناجر وساندوتش بانل جدة - تصميم ${idx + 1}`}
                                    fill
                    ...
                    <h2 className="text-2xl font-bold text-brand-primary mb-6">{t('pnTypesTitle' as any)}</h2>
                    ...
                    <div className="grid grid-cols-1 gap-8">
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100">
                            <div className="relative h-64 w-full group overflow-hidden">
                                <Image
                                    src="/images/sandwich-panel/sandwich-small.webp"
                                    alt={t('pnType1Title' as any)}
                                    fill
                            ...
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2">{t('pnType1Title' as any)}</h3>
                                <p className="text-slate-600">{t('pnType1Desc' as any)}</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100">
                            <div className="relative h-64 w-full group overflow-hidden">
                                <Image
                                    src="/images/sandwich-panel/hangar-sandwich.webp"
                                    alt={t('pnType2Title' as any)}
                                    fill
                                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                                    loading="lazy"
                                />
                            ...
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2">{t('pnType2Title' as any)}</h3>
                                <p className="text-slate-600">{t('pnType2Desc' as any)}</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100">
                            <div className="relative h-64 w-full group overflow-hidden">
                                <Image
                                    src="/images/sandwich-panel/sandwich-panel-2.webp"
                                    alt={t('pnType3Title' as any)}
                                    fill
                                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                                    loading="lazy"
                                />
                            ...
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2">{t('pnType3Title' as any)}</h3>
                                <p className="text-slate-600">{t('pnType3Desc' as any)}</p>
                            </div>
                        </div>
                    </div>
